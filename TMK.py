...
def approval():
	...
	if key in ress:
		...
		os.system("clear")
		print(f"\033[1;31m   COPY YOUR KEY AND SEND TO ADMIN  ")
		print("THIS TOOL.IS PAID BUT YOU NEED PERMITION TO USE IT")
		print(f"    Send payment to Admin and get aproval")
		print("Your key : "+Tamim+key+Nijum)
		print("====")
		name = input("YOUR NAME ")
		os.system("xdg-open https://wa.me/+8801537278905")
#logo		
